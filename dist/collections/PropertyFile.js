...
var yourOwnAndPurchased = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var user, property, ownProductFiles, Orders, purChasedProductFiles;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    Orders = (_b.sent()).docs;
                    purChasedProductFiles = Orders.map(function (order) {
                        return order.products.map(function (product) {
                            if (typeof product === 'string')
                                return req.payload.logger.error('search error');
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFiles, true), purChasedProductFiles, true)
                            }
                        }];
            }
        });
